...
<body>
	...
	<div align= "center" class="rightpane">
		...
		<h2 style="font-family:verdena">INBOX</h2>
		<% List<MailBean> mailList = (List<MailBean>)request.getAttribute("mailList");%>
			<table class= "tab2">
				<tr>
					...
					<% Iterator<MailBean> iter = mailList.iterator();
						...
						<td><a href="deleteinboxmail?sendfrom=<%=bean.getSendFrom()%>&
